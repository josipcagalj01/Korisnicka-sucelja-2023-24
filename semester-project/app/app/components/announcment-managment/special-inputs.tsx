...
export function RadioNumberInput2 ({control, name, number_value, onClick}: Omit<NumberRadioInputProps, 'control'> & {control: Control<{template_id?: number, useTemplate: boolean}>}) {
	return (
		<Controller
			control={control}
			name={name}
...
export function MyBooleanInput2({ control, name, trueText, falseText, disableTrue, disableFalse, reversed=false, onClickFalse, onClickTrue }: Omit<booleanInputProps , 'control'> & {control: Control<{template_id?: number, useTemplate: boolean}>}) {
	return (
		<Controller
			control={control}
			name={name}
